 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="brand-link" style="text-align: center;">
      <span class="brand-text">SKB Emporium</span>
    </div>

    <!-- Sidebar -->
    <div class="sidebar">

    <div class="user-panel mt-e pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{ url('public/assets/dist/img/photo3.jpg') }}" class="img-circle elevation-2">
      </div>
      <div class="info">
